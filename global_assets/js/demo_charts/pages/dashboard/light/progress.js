...
var DashboardProgress = function() {
    ...
    return {
        init: function() {
            _ProgressRoundedChart('#hours-available-progress', 38, 2, '#F06292', 0.68, 'icon-watch text-pink', 'Hours available', '64% average');
            _ProgressRoundedChart('#goal-progress', 38, 2, '#003049', 0.82, 'icon-trophy3 text-indigo', 'Productivity goal', '87% average');
        }
    }
}();
